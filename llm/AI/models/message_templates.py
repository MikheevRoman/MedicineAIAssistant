...
@dataclass
class StageMessages:
    """Класс для хранения списка сообщений для определенного этапа диалога"""
    messages: List[str]

# Сообщения для начала диалога и очистки сессии
...
# Сообщения для переходов между этапами диалога
